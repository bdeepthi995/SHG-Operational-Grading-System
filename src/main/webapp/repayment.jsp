...
<html>
<head>
    <title>Loan Repayment - SHG Grading System</title>
    ...
    <div class="container mt-4">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0">Loan Repayment Tracking</h3>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <div class="mt-2">
                            <small class="text-muted">Time remaining to mark payments</small>
                        </div>
                    </div>
                </div>
                
                <form id="repaymentForm" action="StartRepayment" method="post">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="loan-input">
                                <label class="fw-bold">Total Loan Amount (Rs):</label>
                                <input type="number" name="loanAmount" class="form-control mt-2" placeholder="Enter loan amount" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="loan-input">
                                <label class="fw-bold">Interest Rate (%):</label>
                                <input type="number" step="0.01" name="interest" class="form-control mt-2" placeholder="Enter interest rate" required>
                            </div>
                        </div>
                    </div>
                    
                    <h5 class="mb-3">Mark Members Who Paid:</h5>
                    <div class="row">
                        <% for (String member : members) { %>
                        <div class="col-md-4">
                            <div class="member-checkbox">
                                <input type="checkbox" name="paid" value="<%= member %>" id="member_<%= member %>">
